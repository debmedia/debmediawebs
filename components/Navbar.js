                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
                        <Nav activeKey={router.pathname} className="ml-auto">
                            ...
                            <NavDropdown title={t("NAVBAR.SOLUTIONS.TITLE")} id="basic-nav-dropdown">
                                ...
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
                                    <Link href="/preatendedor">{t("NAVBAR.SOLUTIONS.WHATSAPP_CHATBOT")}</Link>
                                </NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
                                    <Link href="/fila-virtual">{t("NAVBAR.SOLUTIONS.VIRTUAL_QUEUE")}</Link>
                                </NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
                                    <Link href="/citasonline">{t("NAVBAR.SOLUTIONS.APPOINTMENTS")}</Link>
                                </NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
                                    <Link href="/debq">{t("NAVBAR.SOLUTIONS.QUEUE_MANAGEMENT")}</Link>
                                </NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
                                    <Link href="/debsign">{t("NAVBAR.SOLUTIONS.DIGITAL_SIGNAGE")}</Link>
                                </NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
                                    <Link href="/preatendedor">{t("NAVBAR.SOLUTIONS.PRE_SERVICE")}</Link>
                                </NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setExpanded(false)}>
